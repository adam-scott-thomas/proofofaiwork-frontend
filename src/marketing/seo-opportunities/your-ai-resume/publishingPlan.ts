...
const tasks = [
  ...
  ["Governance", "ai-resume-pages-to-avoid", "Publish internal guidance.", "The page blocks generic builder, ATS myth, and doorway-page drift."],
  ["Internal linking", "your-ai-resume-linking-pass", "Connect the package to the core SEO hub.", "Every page links to AI capability proof, AI work samples, and at least one resume comparison page."],
